...
## Ответ
***Примичание:*** Изначально, я начал делать без Docker Compose и соответственно без предложенных контейнеров ~~(потому что я слепой)~~, о чем потом сильно пожалел, т.к. там почти все уже было прописано. Пришлось все в ручную делать, ибо начинать с начала я был уже не в силах.
